    ...
    return(
        <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
               ...
               <th scope="col" className="px-6 py-3 w-2/12">Move Task</th>
            </tr>
        </thead>
    );
}
...
const TaskTable = (props) => {
    ...
    return(
        <table className=" w-full text-sm text-left text-gray-500 border rounded-lg overflow-hidden dark:text-gray-600 ">
            <TaskHeader />
